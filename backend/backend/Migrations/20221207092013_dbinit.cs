        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifitedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Size_Category_SizeCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quatity", x => new { x.ProductId, x.ColorId, x.SizeId });
                    table.ForeignKey(
                        name: "FK_Quantity_Color",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quatity_ColorId",
                table: "Quatity",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_Quatity_SizeId",
                table: "Quatity",
                column: "SizeId");
